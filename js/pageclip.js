    ...
    var t = function() {},
        s = {
                        ...
                        i &&
                            ...
                            s._send(r.key, r.url, a, o, n, function(e, r) {
                                i && s._hideSubmitting(t),
                                    ...
                                    !1 !== (!n.onResponse || n.onResponse(e, r)) && !e && s._showSuccess(t, f),
            ...
            send: function(e, t, n, r) {
                var o = s._base + "/" + e + "/" + (t || "");
                s._send(e, o, {"X-REQMETHOD": "send-v1", "Content-Type": "application/json"}, JSON.stringify(n), {}, r);
            },
                            ...
                            if (4 === c.readyState) {
                                var e = c.response,
                                    t =
                                        200 === c.status
                                            ? null
                                            : new Error("Error submitting data: " + (e ? e.error : "Unknown Error"));
                                a(t, t ? null : e);
                            }
                        } catch (t) {
            ...
            _sendError: function(e, t) {
                var n =
                        '{"error": "' +
                        (t.stack || t.message || t + "").replace(/"/g, '\\"').replace(/\n/g, "\\n") +
                        '"}',
                    r = s._xhr();
