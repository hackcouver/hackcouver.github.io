    ...
    (gj.grid.methods = {
                ...
                (g = $('<th data-field="' + (c[i].field || "") + '" />')),
                    ...
                    "selectRow" === c[i].role
                        ...
                        : ((h = $('<div data-role="title"/>').html(void 0 === c[i].title ? c[i].field : c[i].title)),
                          g.append(h),
                          c[i].sortable &&
                              (h.addClass(d.sortable), h.on("click", gj.grid.methods.createSortHandler(a, c[i])))),
                    c[i].hidden && g.hide(),
                    f.append(g);
            e.empty().append(f);
        },
        ...
        getCell: function(a, b, c) {
            ...
            return (
                ...
                d > -1 &&
                    ((e = gj.grid.methods.getRowById(a, b)), (f = e.find("td:eq(" + d + ') div[data-role="display"]'))),
                f
            );
        },
            ...
            downloadCSV: function(a, b) {
                ...
                return (
                    ...
                    window.navigator.userAgent.indexOf("Edge") > -1
                        ? (c.href = URL.createObjectURL(new Blob([this.getCSV(b)], {type: "text/csv;charset=utf-8;"})))
    ...
    (gj.tree.methods = {
        ...
        appendNode: function(a, b, c, d, e) {
            ...
            if (
                ...
                (hasChildren =
                    void 0 !== c[k.hasChildrenField] && "true" === c[k.hasChildrenField].toString().toLowerCase()),
                ...
                k.imageCssClassField && c[k.imageCssClassField]
                    ? ((i = $('<span data-role="image"><span class="' + c[k.imageCssClassField] + '"></span></span>')),
                    ...
                    : k.imageHtmlField &&
                      c[k.imageHtmlField] &&
                      ((i = $('<span data-role="image">' + c[k.imageHtmlField] + "</span>")), i.insertBefore($display)),
                ...
                for (b = 0; b < f.length; b++)
                    (c = $(f[b])),
                        "true" === c.attr("data-selected")
                            ...
                            : c.has("ul") &&
                              ((d = gj.tree.methods.getSelections(c.children("ul"))), d.length && (e = e.concat(d)));
            return e;
        },
        ...
        select: function(a, b) {
            ...
            return (
                ...
                g
                    ...
                    : (c.placeholder && (f[0].innerHTML = '<span class="placeholder">' + c.placeholder + "</span>"),
                      (a[0].value = "")),
        ...
        destroy: function(a) {
            ...
            return (
                b &&
                    ...
                    a.removeClass(),
                    c.length > 0 &&
                        (c.children('[role="presenter"]').remove(), c.children('[role="list"]').remove(), a.unwrap()),
                    a.show()),
                a
            );
        }
        ...
        createCalendar: function(a, b) {
            ...
            return (
                ...
                b.footer &&
                    ...
                    (f = $(
                        '<button class="' + b.style.button + '">' + gj.core.messages[b.locale].cancel + "</button>"
                    )),
                    f.on("click", function() {
                        a.close();
                    }),
        ...
        createNavigation: function(a, b, c, d) {
            ...
            for (
                f = $('<div role="navigator" />'),
                    f.append(
                        $("<div>" + d.icons.previousMonth + "</div>").on("click", gj.datepicker.methods.prev(a, d))
                    ),
            ...
            for (
                ...
                (f = i[n.month] - k + l),
                    ...
                    c.calendarWeeks &&
                        1 === l &&
                        $row.append(
                            '<td class="calendar-week"><div>' + gj.datepicker.methods.getWeekNumber(r) + "</div></td>"
                        ),
    ...
    (gj.slider.methods = {
        ...
        initialize: function(a, b) {
            ...
            (a[0].style.display = "none"),
                ...
                null == f &&
                    ((f = document.createElement("div")), f.setAttribute("role", "progress"), c.appendChild(f)),
